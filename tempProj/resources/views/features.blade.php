...
@section('title') Характеристики @endsection
...
@section('main_content')
    ...
    <section class="mt-5">
        <div class="container">
            ...
            <div class="text-center aos-init aos-animate" data-aos="zoom-in">
    ...
    <section class="py-6 bg-light-primary mt-5">
        <div class="container">
                ...
                <div class="col my-3">
                    <div class="card border-hover-primary hover-scale">
                        <div class="card-body">
                            ...
                            <h6 class="font-weight-bold mb-3 text-black">Marketing Automation</h6>
                ...
                <div class="col my-3">
                    <div class="card border-hover-primary hover-scale">
                        <div class="card-body">
                            ...
                            <h6 class="font-weight-bold mb-3 text-black">Social Media Marketing</h6>
                            <p class="text-muted mb-0">Embed holistics charts directly to your application</p>
                        </div>
                    </div>
                </div>
                <div class="col my-3">
                    <div class="card border-hover-primary hover-scale">
                        <div class="card-body">
                            ...
                            <h6 class="font-weight-bold mb-3 text-black">Search Engine Marketing</h6>
                            <p class="text-muted mb-0">Embed holistics charts directly to your application</p>
                        </div>
                    </div>
                </div>
                <div class="col my-3">
                    <div class="card border-hover-primary hover-scale">
                        <div class="card-body">
                            ...
                            <h6 class="font-weight-bold mb-3 text-black">Search Engine Optimization</h6>
                            <p class="text-muted mb-0">Embed holistics charts directly to your application</p>
                        </div>
                    </div>
                </div>
                <div class="col my-3">
                    <div class="card border-hover-primary hover-scale">
                        <div class="card-body">
                            ...
                            <h6 class="font-weight-bold mb-3 text-black">Website and Landing Page</h6>
                            <p class="text-muted mb-0">Embed holistics charts directly to your application</p>
                        </div>
                    </div>
                </div>
                <div class="col my-3">
                    <div class="card border-hover-primary hover-scale">
                        <div class="card-body">
                            ...
                            <h6 class="font-weight-bold mb-3 text-black">Graphics and Logo Design</h6>
                            <p class="text-muted mb-0">Embed holistics charts directly to your application</p>
                        </div>
                    </div>
                </div>
                <div class="col my-3">
                    <div class="card border-hover-primary hover-scale">
                        <div class="card-body">
                            ...
                            <h6 class="font-weight-bold mb-3 text-black">Project Management</h6>
                            <p class="text-muted mb-0">Embed holistics charts directly to your application</p>
                        </div>
                    </div>
                </div>
                <div class="col my-3">
                    <div class="card border-hover-primary hover-scale">
                        <div class="card-body">
                            ...
                            <h6 class="font-weight-bold mb-3 text-black">Task management</h6>
                            <p class="text-muted mb-0">Embed holistics charts directly to your application</p>
                        </div>
                    </div>
                </div>
                <div class="col mb-0 mt-3 mb-lg-3">
                    <div class="card border-hover-primary hover-scale">
                        <div class="card-body">
                            ...
                            <h6 class="font-weight-bold mb-3 text-black">Client Dashboards</h6>
                            <p class="text-muted mb-0">Embed holistics charts directly to your application</p>
                        </div>
                    </div>
                </div>
